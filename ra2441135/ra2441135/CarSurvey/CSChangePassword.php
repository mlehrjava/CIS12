<?php # CSChangePassword.php - Change Password
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	{ // If everything's OK.
		...
		$q = "SELECT userID FROM ra2441135_survey_entity_users WHERE (email='$_SESSION[email]' AND pass=SHA1('$p') )";
		...
		if ($num == 1) { // Match was made.
			...
			$q = "UPDATE ra2441135_survey_entity_users SET pass=SHA1('$np') WHERE userID=$row[0]";		
			$r = @mysqli_query($con, $q);
