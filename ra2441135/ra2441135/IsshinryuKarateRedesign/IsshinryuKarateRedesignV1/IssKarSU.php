...
karate.com/images/0ee079d2df5c99036753aff72348ba5b_a9hq.jpg" />
        ...
        <a class="signin" href="IssKarSI.html">Sign In</a>
...
Black Belts</a></li>
    ...
    <div class="right">
        ...
        <h2 style="text-align:center;margin:0px 100px 0px 100px;">Once you have taken your Free Trial Class you may obtain the Super Secret Phrase and create an account <a class="createaccount" href="IssKarCA.html">HERE</a>.</h2>
      
<?php
// define variables and set to empty values
$FirstNameErr = $LastNameErr = $emailErr = $ChildFirstNameErr = $ChildLastNameErr = 
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    First Name:
    <br />
    <input class="input_field" type="text" name="FirstName" value="<?php echo 
...
$FirstName;?>">
   <span class="error">* <?php echo $FirstNameErr;?></span>
    ...
    Last Name:
    <br />
    <input class="input_field" type="text" name="LastName" value="<?php echo 
...
$LastName;?>">
    ...
    Child First Name:
    <br />
    <input class="input_field" type="text" name="ChildFirstName" value="<?php echo 
...
$ChildFirstName;?>">
    ...
    Child Last Name:
    <br />
    <input class="input_field" type="text" name="ChildLastName" value="<?php echo 
...
$ChildLastName;?>">
   ...
   <br />
   <select class="input_field" name="times"<?php echo $times;?>>
                <option value=></option>
                <option value="Kids 4 Years and Older: Tuesday 5:00PM to 6:00PM">Kids 4 

Years and Older: Tuesday 5:00PM to 6:00PM</option>
                <option value="Kids 4 Years and Older: Tuesday 6:00PM to 7:00PM">Kids 4 

Years and Older: Tuesday 6:00PM to 7:00PM</option>
                <option value="Kids 4 Years and Older: Thursday 6:00PM to 7:00PM">Kids 

4 Years and Older: Thursday 5:00PM to 6:00PM</option>
                <option value="Kids 4 Years and Older: Thursday 6:00PM to 7:00PM">Kids 

4 Years and Older: Thursday 6:00PM to 7:00PM</option>
                <option value="Adults: Tuesday 7:00PM to 8:00PM">Adults: Tuesday 7:00PM 

to 8:00PM</option>
                <option value="Adults: Thursday 7:00PM to 8:00PM">Adults: Thursday 

7:00PM to 8:00PM</option>
            </select>
            <span class="error">* <?php echo $emailErr;?></span>
   <br /><br />
...
ChildFirstName, ChildLastName, email, times)
            VALUES ('$_POST[FirstName]','$_POST[LastName]','$_POST

[ChildFirstName]','$_POST[ChildLastName]','$_POST[email]','$_POST[times]')";
...
Please click here to <a href='IssKarSU.php' style='text-decoration:none;font-
