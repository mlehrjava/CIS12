...
<p style="text-align:right; margin-right:70px;">Arnold R Sandubrae</p>
        <iframe class="termIframe" width="90%" height="74.5%" frameborder="5" scrolling="auto" marginheight="0" marginwidth="0" src="
        	<?php 	if(isset($_SESSION['userID']))
            	    {
                        if (($_SESSION['userID'] == 1) && ($_SESSION['FirstName'] == 'Ricky'))
                        {
                            echo 'admin/IssKarAdminTerms.php';
                        }
                    }
                    else
                    {
                        echo 'IssKarTerms.php';
                    }  ?>"></iframe>
