...
<?php # IssKarAdminTerms.php - List of Terms for the Admin to Manage
// This page displays a list of terms to the admin and allows Editting and Deleting of terms.
session_start();
...
echo '<tr bgcolor="' . $bg . '">
<td align="left"><a class="sortLink" href="IssKarEditTerm.php?id=' . $row['termId'] . '">Edit</a></td>
<td align="left"><a class="sortLink" href="IssKarDeleteTerm.php?id=' . $row['termId'] . '">Delete</a></td>
