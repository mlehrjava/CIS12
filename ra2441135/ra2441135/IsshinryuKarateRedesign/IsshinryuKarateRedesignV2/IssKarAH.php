<?php # IssKarAH.php - Awards and Honors
// This page displays a list of Sandubrae's Awarads and Honors.

$page_title = 'IssKarAH.php';
$bgImg = 'http://www.kingcustom.net/assets/images/medals/five%20star%20medals/36623g-karate-male-martial-arts-sport-five-star-award-medal.jpg';
include ('IssKarHeader.inc.html');
include ('IssKarNavbar.inc.html');
?>

<h1>The following is a partial listing of major awards and honors that have been bestowed upon Sensei Sandubrae since his entry into Isshinryu Karate :</h1>
