...
// This script creates a sign up form to be displayed and handled.

$page_title = 'IssKarSU.php';
...
<form action="IssKarCA.php" method="post">
	<p>First Name: <input class="input_field" type="text" name="FirstName" maxlength="20" value="<?php if (isset($_POST['FirstName'])) echo $_POST['FirstName']; ?>" /></p>
	<p>Last Name: <input class="input_field" type="text" name="LastName"  maxlength="40" value="<?php if (isset($_POST['LastName'])) echo $_POST['LastName']; ?>" /></p>
	<p>Email Address: <input class="input_field" type="text" name="email"  maxlength="60" value="<?php if (isset($_POST['email'])) echo $_POST['email'];?>"  /> </p>
	<p>Password: <input class="input_field" type="password" name="pass1"  maxlength="20" value="<?php if (isset($_POST['pass1'])) echo $_POST['pass1']; ?>"  /></p>
	<p>Confirm Password: <input class="input_field" type="password" name="pass2" maxlength="20" value="<?php if (isset($_POST['pass2'])); ?>"  /></p>
	<p>Enter the Super Secret Phrase you received at your Free Trial Class: <input class="input_field" type="text" name="SSP" maxlength="20" value="<?php if (isset($_POST['SSP'])) echo $_POST['SSP']; ?>"  /></p>
