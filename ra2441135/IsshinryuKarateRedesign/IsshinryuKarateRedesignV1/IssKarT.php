...
<head>
    ...
    <style>
        #background
        {
            background-image:url("http://behance.vo.llnwd.net/profiles2/203106/projects/615767/ceaf32770934a92745fec8552e7f7051.png");
        }
    </style>
</head>
<body>
    <div id="header">
        <h1><img id="titleImg1" src="http://isshinryu-karate.com/images/0ee079d2df5c99036753aff72348ba5b_a9hq.jpg" />
	...
	<a class="signin" href="IssKarSI.php">Sign In</a>
        <img id="titleImg2" src="http://isshinryu-karate.com/images/0ee079d2df5c99036753aff72348ba5b_a9hq.jpg" /></h1>
    </div>
    <div class="left">
        <ul>
...
<p style="text-align:right; margin-right:70px;">Arnold R Sandubrae</p>
        <iframe class="termIframe" width="95%" height="70%" frameborder="5" scrolling="auto" marginheight="0" marginwidth="0" src="IssKar.php"></iframe>
