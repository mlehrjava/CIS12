...
<body>
    ...
    <div class="right">
        ...
        <?php
            ...
            $sql="INSERT INTO ra2441135_isskar_entity_users (FirstName, LastName, UserName, password)
            ...
            if (!mysqli_query($con,$sql))
            {
                ...
                echo "We&#39;re Sorry, there was an error processing your information. Please click here to <a href='IssKarCA.html' style='text-decoration:none;font-weight:bold;color:#e71008;'>Try Again!</a>";
            }
            else
            {
                echo "<p>Welcome <span id=username>$uName</span>. You are now logged in.<p>";
            }
            //echo "1 record added";
            //close connection
            mysqli_close($con);
